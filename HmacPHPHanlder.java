 ...
 * 2017-06-22 17:03:55【PHP调用】
 * Created by mah on 2015/10/28.
 */
public class HmacPHPHanlder {
    ...
    public HmacPHPHanlder(String macKey){
        this.macKey = macKey;
    }

    public HmacPHPHanlder(String macKey, String defaultEncryptType){
        this.macKey = macKey;
